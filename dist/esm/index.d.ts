...
declare class BleManager extends NativeEventEmitter {
     ...
     * @returns
     */
    retrieveServices(peripheralId: string, serviceUUIDs?: string[], characteristicFilters?: [string, string][], discoverDescriptors?: boolean, discoverIncludedServices?: boolean): Promise<PeripheralInfo>;
    /**
     *
     * @param peripheralId
     * @param serviceUUID
